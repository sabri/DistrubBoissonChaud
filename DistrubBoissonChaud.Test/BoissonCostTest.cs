...
namespace TestFunctions
{
    ...
    public class BoissonCostTest
    {
        ...
        public void CalculCost_Expresso_boisson()
        {
            ...
            string expect = "Le coût de recette expresso est 1.2 et le prix de Vente est 1.56";
        ...
        public void CalculCost_allongé_boisson()
        {
            ...
            rec.Eau = 2;
            var res = BoissonCost.CalculCostBoission(rec);
            string expect = "Le coût de recette allongé est 1.4 et le prix de Vente est 1.8199999999999998";
            Assert.That(res, Is.EqualTo(expect));
        }
        ...
        public void CalculCost_allonge_boisson()
        {
            ...
            rec.Eau = 2;
            var res = BoissonCost.CalculCostBoission(rec);
            string expect = "Le coût de recette allonge est 1.4 et le prix de Vente est 1.8199999999999998";
            Assert.That(res, Is.EqualTo(expect));
        }
        ...
        public void CalculCost_capuccino_boisson()
        {
            ...
            rec.Creme = 1;
            var res = BoissonCost.CalculCostBoission(rec);
            string expect = "Le coût de recette capuccino est 2.7 et le prix de Vente est 3.5100000000000002";
            Assert.That(res, Is.EqualTo(expect));
        }
        ...
        public void CalculCost_Chocolat_boisson()
        {
            ...
            rec.Sucre = 1;
            var res = BoissonCost.CalculCostBoission(rec);
            string expect = "Le coût de recette chocolat est 4.1 et le prix de Vente est 5.329999999999999";
            Assert.That(res, Is.EqualTo(expect));
        }
        ...
        public void CalculCost_thé_boisson()
        {
            ...
            rec.Eau = 2;
            var res = BoissonCost.CalculCostBoission(rec);
            string expect = "Le coût de recette thé est 2.4 et le prix de Vente est 3.12";
            Assert.That(res, Is.EqualTo(expect));
        }
        ...
        public void CalculCost_the_boisson()
        {
            ...
            rec.Eau = 2;
            var res = BoissonCost.CalculCostBoission(rec);
            string expect = "Le coût de recette the est 2.4 et le prix de Vente est 3.12";
            Assert.That(res, Is.EqualTo(expect));
        }
        [Test]
        public void CalculCost_autre_boisson()
        {
            ...
            rec.Creme = 0;
            var res = BoissonCost.CalculCostBoission(rec);
            string expect = "Le coût de recette autre est 2.4 et le prix de Vente est 3.12";
            Assert.That(res, Is.EqualTo(expect));
        }
    }
}